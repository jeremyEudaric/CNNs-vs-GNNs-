# This is the experimental version of slide with annotation and ti
...
class Slide:
    ...
    def __init__(self, slideFilePath, newSlideFilePath=None, level=0, verbose=False):
        ...
        try:
            ...
            if 'vips-loader' not in self.slideProperties:
                ...
                print(self.slideProperties['vips-loader'])
    ...
    def detectForeground(self, level=0, overwriteExistingForegroundDetection=False, threshold=None):
       ...
       # if not self.hasTileDictionary():
        ...
        self.lowMagSlide = pv.Image.new_from_file(self.slideFilePath, page=level)
    ...
    def extractRandomUnannotatedTiles(self, outputDir, slideName=False, numTilesToExtract=100, unannotatedClassName='unannotated', otherClassNames=False,
        extractSegmentationMasks=False,tissueLevelThreshold=False, foregroundLevelThreshold=False, returnTileStats=True, seed=False):
    ...
    def detectTissue(self, tissueDetectionLevel=1, tissueDetectionTileSize=512, tissueDetectionTileOverlap=0, tissueDetectionUpsampleFactor=4, batchSize=20, numWorkers=16, overwriteExistingTissueDetection=False, modelStateDictPath='/Users/eudari01/anaconda3/lib/python3.9/site-packages/slidl/models/deep-tissue-detector_densenet_state-dict.pt', architecture='densenet'):
